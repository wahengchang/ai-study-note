...
| Content + Application | `SaveRevision` 在 canonical write 前以 real PluginHost snapshot 執行 validator；`PublishRevision` 重新驗證 selected current revision 的 schema、media 與 route proposal，僅原子更新 published pointer／claim 與 non-revision lineage。 | [CMS-CORE-02](../specs/cms-basic-contracts-v1/02-content-lifecycle-application-core.md) | [public entry](../core/application/index.ts)；[SaveRevision](../tests/core/application/save-revision.test.ts)、[SaveRevision failures](../tests/core/application/save-revision-failures.test.ts)、[Plugin composition](../tests/core/application/save-revision-plugin-composition.test.ts)、[PublishRevision](../tests/core/application/publish-revision.test.ts) |
