...
| External Authoring API | External Authoring API v1 security contract 已核准；server、credential store、CLI client、CMS browser bootstrap 與 HTTP tests 尚無入口。 | [implementation contract §7](../contracts/README.md#7-external-authoring-api-v1已核准runtime-尚未實作) | 尚無程式與測試入口；依 #241 child Issues 逐一建立 real vertical slice。 |
