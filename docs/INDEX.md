...
| Content + Application | 內容生命週期與 `DomainApplication` command boundary 已核准，尚無程式與測試入口。 | [CMS-CORE-02](../specs/cms-basic-contracts-v1/02-content-lifecycle-application-core.md) | 尚無程式與測試入口。 |
| Site Definition | normalized route-claim registry 與 graph snapshot 已核准，尚無程式與測試入口。 | [CMS-CORE-03](../specs/cms-basic-contracts-v1/03-route-graph-application-core.md) | 尚無程式與測試入口。 |
| DataMedia | checksum object、asset version、revision reference 與 import lifecycle 已核准，尚無程式與測試入口。 | [CMS-CORE-04](../specs/cms-basic-contracts-v1/04-media-lifecycle-application-core.md) | 尚無程式與測試入口。 |
