...
| 規劃或實作 current-only CMS/Core data reset | [implementation contract](../contracts/README.md)、[CMS Core/Data reset 規格](../specs/cms-core-data-reset.md) | [Persistence contracts](../core/persistence/contracts.ts)、[Application](../core/application/)、[Authoring API](../apps/authoring-api/)、[CMS workspace](../apps/cms/workspace.tsx) | [Persistence tests](../tests/core/persistence/)、[Application tests](../tests/core/application/)、[Authoring API contract](../tests/apps/authoring-api/http-contract.test.ts)、[CMS browser tests](../tests/apps/cms/)；新 target 尚未實作，現行程式與測試仍是 baseline |
