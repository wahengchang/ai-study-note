...
| External Authoring API + CMS Workspace | local credential lifecycle、fixed-origin browser ticket/session、production CMS composition、Content Type／Article workspace 與 runtime-pinned Theme 的 current/published Preview 已實作；`cms:serve` 以 exact Theme id/version/manifest hash 在 listener 前 resolve installed Theme。 | [implementation contract §7](../contracts/README.md#7-external-authoring-api-v1已實作-production-composition) | [public entry](../apps/authoring-api/index.ts)、[runtime](../apps/authoring-api/cms-runtime.ts)、[serve CLI](../apps/authoring-api/serve.ts)；[HTTP preview](../tests/apps/authoring-api/http-contract.test.ts)、[serve](../tests/apps/authoring-api/cms-serve.test.ts)、[bootstrap](../tests/apps/authoring-api/cms-browser-bootstrap.test.ts)。 |
