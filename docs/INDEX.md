...
| DataMedia | local import 建立 ready asset version；`resolvePublishedSelection` 只從 published pointer 解析完整已驗證 media selection，任一不健康 reference 在輸出前 fail closed。 | [CMS-CORE-04](../specs/cms-basic-contracts-v1/04-media-lifecycle-application-core.md) | [public entry](../core/media/index.ts)；[local import](../tests/core/media/local-import.test.ts)、[published selection](../tests/core/media/published-selection.test.ts) |
