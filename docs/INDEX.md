...
| Content + Application | `SaveRevision`／`PublishRevision` 維持既有原子 pointer/claim/lineage 生命週期；`RestoreRevision` 由 immutable source 建立附 `restoredFromRevisionId` 的新 current revision，預先阻擋 archived/missing media，published 維持 pin。 | [CMS-CORE-02](../specs/cms-basic-contracts-v1/02-content-lifecycle-application-core.md) | [public entry](../core/application/index.ts)；`tests/core/application/` |
...
| DataMedia | local import 建立 ready asset version；ArchiveAsset 以 active published reference gate 保護，RestoreAsset 僅接受 exact immutable evidence 的 recovery；published selection 對任何不健康 reference fail closed。 | [CMS-CORE-04](../specs/cms-basic-contracts-v1/04-media-lifecycle-application-core.md) | [public entry](../core/media/index.ts)；`tests/core/media/` |
