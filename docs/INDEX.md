...
| External Authoring API | local credential lifecycle、fixed-origin server proof 與 Bearer authenticated `SaveRevision` 已實作；browser ticket／session bootstrap 仍未實作。 | [implementation contract §7](../contracts/README.md#7-external-authoring-api-v1已核准runtime-尚未實作) | [public entry](../apps/authoring-api/index.ts)；[credential lifecycle](../tests/apps/authoring-api/credential-lifecycle.test.ts)、[HTTP contract](../tests/apps/authoring-api/http-contract.test.ts)。 |
