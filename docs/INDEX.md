...
| External Authoring API | local credential lifecycle、fixed-origin server proof、Bearer authenticated `SaveRevision` 與 `cms:save-revision` CLI client 已實作；browser ticket／session bootstrap 仍未實作。 | [implementation contract §7](../contracts/README.md#7-external-authoring-api-v1已核准runtime-部分實作) | [public entry](../apps/authoring-api/index.ts)；[credential lifecycle](../tests/apps/authoring-api/credential-lifecycle.test.ts)、[HTTP contract](../tests/apps/authoring-api/http-contract.test.ts)、[credential CLI](../tests/apps/authoring-api/credential-cli.test.ts)、[SaveRevision CLI](../tests/apps/authoring-api/save-revision-cli.test.ts)。 |
