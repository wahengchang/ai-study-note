...
| Projection + Preview | published-only `renderer-input/v1` producer、single-subject current/published Preview 與 canonical parser 已實作；不含 Renderer、Delivery 或 HTTP transport。 | [implementation contract](../contracts/README.md) | [public entry](../core/projection/index.ts)；[published isolation](../tests/core/projection/preview-isolation.test.ts)。 |
