...
UPDATE post_types SET current_schema_version_id = 'pts-v1', published_schema_version_id = 'pts-v1' WHERE id = 'pt-page';
...
UPDATE taxonomies SET current_version_id = 'tax-v1', published_version_id = 'tax-v1' WHERE id = 'tax-topic';
...
UPDATE terms SET current_revision_id = 'tr-v1', published_revision_id = 'tr-v1', first_published_at = '2026-08-25T00:00:00Z' WHERE id = 'term-ai';
...
UPDATE entries SET current_revision_id = 'er-v1', published_revision_id = 'er-v1', first_published_at = '2026-08-25T00:00:00Z' WHERE id = 'entry-one';
...
VALUES ('idem-one', 'entries:create', 'key-one', 'aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa', 'completed', '2026-08-26T00:00:00Z', '2026-08-25T00:00:00Z', '2026-08-25T00:00:00Z');
