...
description: >-
  Configure Chrome DevTools for MCP debugging — remote debugging port, DOM
...
- Chrome 選單 -> `View -> Developer -> Developer Tools`
  ![](/ai-study-note/assets/Chrome with DevTools opened.png)
...
![](/ai-study-note/assets/CodexApp with DevTools opened.png)
