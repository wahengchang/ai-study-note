...
/**
 * `/v1/entries/:entryId/revisions` 的 entryId 字面格式：單一 unreserved path
 * segment。client 與 CLI 共用同一份常數，否則兩邊各自寫死會讓 CLI 接受、client
 * 拒絕（或反之）的 entryId 產生無法解釋的 `INVALID_CLIENT_REQUEST`。
 */
