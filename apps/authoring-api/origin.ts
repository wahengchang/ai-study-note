...
/**
 * 所有 Authoring HTTP resource identity 的字面格式：單一 unreserved path
 * segment，且明確拒絕 dot segment，避免 route 與 canonical identity 脫節。
 */
export const AUTHORING_RESOURCE_ID_PATTERN = /^(?!\.{1,2}$)[A-Za-z0-9._~-]+$/u;
