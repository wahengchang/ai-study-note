...
const messages: Readonly<Record<PersistenceFailureCode, string>> = {
  ...
  CURRENT_MEDIA_ASSET_NOT_FOUND: "找不到指定的 current media asset。",
  CURRENT_MEDIA_ASSET_CONFLICT: "Current media asset 與既有紀錄衝突。",
  CURRENT_MEDIA_REFERENCE_CONFLICT: "Current media reference 與既有紀錄衝突。",
