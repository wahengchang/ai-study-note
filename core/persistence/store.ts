...
import type {
  AssetVersionIdentity, CompareAndReplacePluginActivationStateInput, CreateRevisionInput, EntryPointerRecord, MediaImportIntent,
  OperationLineageIdentity, PersistenceCanonicalState, PersistenceFailure, PersistenceFailureCode, PersistenceResult, PersistenceStore,
  PersistenceTransaction, PluginActivationStateRecord, ReadyAssetVersionRecord, RevisionIdentity, RevisionRecord, RevisionReferenceRecord, RouteClaimRecord,
