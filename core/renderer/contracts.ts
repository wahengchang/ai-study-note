...
export type RendererFailure = Readonly<{ code: "INVALID_RENDERER_INPUT" | "RENDERER_INPUT_DIGEST_MISMATCH" | "RENDERER_MODULE_INVALID" | "RENDERER_CALLBACK_FAILED" | "RENDERER_CALLBACK_RESULT_INVALID" | "RENDER_OUTPUT_CONFLICT"; owner: "Renderer"; subjectIds: readonly string[]; remediation: MessageRemediation }>;
