...
export type RendererSeo = Readonly<{ status: "available"; pages: readonly RendererSeoPage[]; publicSiteUrl?: string; omissionDigest: Digest }> | Readonly<{ status: "omitted"; pages: readonly never[]; omissionDigest: Digest }>;
