...
對應 GitHub #246。
完成 real PluginHost／Persistence／SiteDefinition／DataMedia composition contract：snapshot replacement、雙 digest、Plugin-owned failure、schema service failure 與 late transaction rollback 均已驗證。
